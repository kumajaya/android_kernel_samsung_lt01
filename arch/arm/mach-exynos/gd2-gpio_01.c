...
static struct gpio_init_data gd2_init_gpios[] = {
	{EXYNOS4_GPA0(6), S3C_GPIO_SFN(0x2), S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPS_UART_CTS */
...
static unsigned int gd2_sleep_gpio_table[][3] = {
	...
	{EXYNOS4_GPA0(6),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* FUEL_SDA_1.8V */
	{EXYNOS4_GPA0(7),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* FUEL_SCL_1.8V */
	...
	{EXYNOS4_GPF0(2),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* OTG_EN */
	...
	{EXYNOS4_GPL2(3),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /* EXTMIC EN */
