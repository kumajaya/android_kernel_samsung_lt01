...
#else
#if !defined(CONFIG_TARGET_TAB3_3G8) && !defined(CONFIG_TARGET_TAB3_WIFI8) && !defined(CONFIG_TARGET_TAB3_LTE8)
...
#if !defined(CONFIG_MACH_ZEST) && !defined(CONFIG_TARGET_TAB3_3G8) && !defined(CONFIG_TARGET_TAB3_WIFI8) && !defined(CONFIG_TARGET_TAB3_LTE8) && !defined(CONFIG_MACH_KONA)
