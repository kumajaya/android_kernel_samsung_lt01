...
#if defined(CONFIG_MFD_MAX77693_ADD_PLATFORM_DEVICE)
#include "board-exynos4212.h"
#endif /* CONFIG_MFD_MAX77693_ADD_PLATFORM_DEVICE */
...
void dc_motor_power(bool on)
{
	...
	regulator = regulator_get(NULL, "vmot_3.3v");
...
static void  sec_charger_cb(int set_cable_type, int cable_sub_type)
{
	...
	defined(CONFIG_TOUCHSCREEN_MMS252)
...
#if defined(CONFIG_SENSORS_GP2A) || defined(CONFIG_SENSORS_BH1730) || \
	defined(CONFIG_SENSORS_CM36653) || defined(CONFIG_SENSORS_CM3323)
...
#if defined(CONFIG_USE_MFC_CMA) && defined(CONFIG_MACH_TAB3)
#ifdef CONFIG_ION_EXYNOS_CONTIGHEAP_SIZE
		{
			.name = "ion",
			.size = CONFIG_ION_EXYNOS_CONTIGHEAP_SIZE * SZ_1K,
...
#if defined(CONFIG_S3C_DEV_I2C6) && defined(CONFIG_SENSORS_ASP01)
...
#if defined(CONFIG_IR_REMOCON_MC96) || defined(CONFIG_ICE4_FPGA)
...
#endif
#ifdef CONFIG_TAB3_00_BD
	exynos_tab3_charger_init();
#endif
#ifdef CONFIG_TAB3_01_BD
	exynos_slim8_charger_init();
#endif
	midas_camera_init();
