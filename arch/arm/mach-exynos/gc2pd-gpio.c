...
static struct gpio_init_data m0_init_gpios[] = {
	...
	{EXYNOS4_GPY4(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* ZRPR_DIR */
...
#elif defined(CONFIG_SEC_MODEM_SP7160LTE)
	{EXYNOS4_GPF1(1),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN}, /* ACTIVE_STATE */
#else
...
#if defined(CONFIG_SEC_MODEM_M0) || defined(CONFIG_SEC_MODEM_SP7160LTE)
	/* GPF1(6) M0, C1, SP7160LTE, let cp know AP sleep status*/
...
/*	{EXYNOS4_GPL1(2),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, */
...
#elif defined(CONFIG_SEC_MODEM_SP7160LTE)
	{EXYNOS4_GPL2(5),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* GPIO_PHONE_ON */
#else
	...
	{EXYNOS4_GPY3(7),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, /* NC */

	{EXYNOS4_GPY4(0),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4_GPY4(1),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* ZRPR_DIR */
	{EXYNOS4_GPY4(2),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4_GPY4(3),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, /* GPIO_PS_ALS_EN_285 */
	{EXYNOS4_GPY4(4),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, /* GPIO_PS_ALS_EN_3 */
#if defined(CONFIG_GC2PD_00_BD)
	/* GPY4(5) NFC_LDO_EN hold high */
	{EXYNOS4_GPY4(5),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* NFC_LDO_EN */
#else
...
#if defined(CONFIG_MACH_GC1_USA_VZW) || defined(CONFIG_MACH_GC1_KOR_SKT) ||\
	defined(CONFIG_MACH_GC1_KOR_KT) || defined(CONFIG_MACH_GC1_KOR_LGT) ||\
	defined(CONFIG_SEC_MODEM_SP7160LTE) /* GPIO_AP_DUMP_INT */
	/*AP2MDM_ERR_FATAL*/
	...
	{EXYNOS4212_GPJ0(4),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},
...
#elif defined(CONFIG_SEC_MODEM_SP7160LTE)
	{EXYNOS4212_GPM3(3),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, /* CP_REQ_RESET */
#else
...
/*                                                                                           
 * GC2PD Rev0.4 GPIO Sleep Table                                                             
 */

static unsigned int m0_sleep_gpio_table_rev04[][3] = {
	{EXYNOS4_GPL2(6),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* NFC_EN */
	{EXYNOS4_GPY3(7),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* FPGA_LDO_EN */
	{EXYNOS4_GPY4(2),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* ISP_ACTIVE */
	{EXYNOS4_GPY4(5),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, /* ISP_CHECK */
};
...
static struct m0_sleep_table m0_sleep_table[] = {
	...
	GPIO_TABLE(m0_sleep_gpio_table_rev04),  /* GC2PD Rev0.4 */
