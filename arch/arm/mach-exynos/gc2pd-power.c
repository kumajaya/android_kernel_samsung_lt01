...
static struct regulator_consumer_supply s5m_ldo13_supply[] = {
    REGULATOR_SUPPLY("vreg_l15_uim1", NULL),
};
#endif
...
S5M_REGULATOR_INIT(s5m_ldo12, "VUOTG_3.0V", 3000000, 3000000, 1,
		REGULATOR_CHANGE_STATUS, 0);
#if defined(CONFIG_MACH_GC2PD)
S5M_REGULATOR_INIT(s5m_ldo13, "VREG_L15_UIM1", 1800000, 3000000, 1,
                   REGULATOR_CHANGE_STATUS, 0);
#endif
...
#if defined(CONFIG_MACH_GC2PD)
    {S5M8767_LDO13, &s5m_ldo13_init_data,},
#endif
	{S5M8767_LDO14, &s5m_ldo14_init_data,},
	{S5M8767_LDO19, &s5m_ldo19_init_data,},
...
struct s5m_opmode_data s5m8767_opmode_data[S5M8767_REG_MAX] = {
	...
	[S5M8767_LDO13] = {S5M8767_LDO13, S5M_OPMODE_STANDBY},
