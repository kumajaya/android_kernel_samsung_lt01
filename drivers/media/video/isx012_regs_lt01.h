...
{0x032B,0x3B,0x01},    // AGCGAIN3_TYPE1 :
...
{0x0331,0x3B,0x01},    // AGCGAIN3_TYPE2
...
{0x6EF6,0xFFE6,0x02},    // IBYHUE1_OUT :
...
{0x6F02,0xFFE6,0x02},    // IBYHUE4_OUT :
...
{0x9676,0x0014,0x02},    // YN_LNRTH_CORE_B :
...
{0x62CA,0x0000,0x02},    // A_LIGHT_AIM_SHIFT_R :
{0x62CC,0x0000,0x02},    // A_LIGHT_AIM_SHIFT_B :
...
// D65 △L대응
{0x5E8B,0x01,0x01},    // EVREF_GAIN_B :
{0x5E8F,0x88,0x01},    // EVREF_TH_A :
{0x5E90,0x90,0x01},    // EVREF_TH_B :

// 
{0x6EDA,0xFFF2,0x02},    // IBYHUE2_POS6 :
{0x6EDE,0xFFF2,0x02},    // IBYHUE3_POS6 :
{0x6ED8,0xFFF5,0x02},    // IRYHUE1_POS6 :
{0x6EDC,0xFFF5,0x02},    // IRYHUE2_POS6 :
{0x6F51,0x57,0x01},    // IBYGAIN2_POS6 :
{0x6F53,0x57,0x01},    // IBYGAIN3_POS6 :
// 
{0x6EEA,0xFFE4,0x02},    // IBYHUE2_POS7 :
{0x6EEE,0xFFE4,0x02},    // IBYHUE3_POS7 :
{0x6EE8,0xFFF5,0x02},    // IRYHUE1_POS7 :
{0x6EEC,0xFFF5,0x02},    // IRYHUE2_POS7 :
{0x6F59,0x57,0x01},    // IBYGAIN2_POS7 :
{0x6F5B,0x57,0x01},    // IBYGAIN3_POS7 :
...
// gamut 대응
{0x6F27,0x62,0x01},    // IBYGAIN1_POS1 : 
{0x6F2D,0x62,0x01},    // IBYGAIN4_POS1 : 
{0x6E86,0xFFEE,0x02},    // IBYHUE1_POS1 : 
{0x6E92,0xFFEE,0x02},    // IBYHUE4_POS1 : 

//indoor 신뢰성 얼굴색 대응 
{0x6F2E,0x5A,0x01},    // IRYGAIN1_POS2 :
{0x6F30,0x5A,0x01},    // IRYGAIN2_POS2 :

// 저조도 대응
{0x6209,0x46,0x01},    // INIT_AEDARK : 47 -> 70
};
...
{0x0006,0x10,0x01},                  //INCK_SET : 12MHz
};
...
{0x701C,0x00DF,0x02},    // G0_KNOT_G14 :
{0x701E,0x00E1,0x02},    // G0_KNOT_G15 :
{0x7020,0x00E1,0x02},    // G0_KNOT_G16 :
{0x7022,0x00E1,0x02},    // G0_KNOT_G17 :
{0x7024,0x00E1,0x02},    // G0_KNOT_G18 :
{0x7026,0x00,0x01},    // G0_KNOT_R0_OFFSET :
{0x7027,0x00,0x01},    // G0_KNOT_R2_OFFSET :
{0x7028,0x00,0x01},    // G0_KNOT_R4_OFFSET :
{0x7029,0x00,0x01},    // G0_KNOT_R6_OFFSET :
...
{0x7064,0x00DD,0x02},    // G0_KNOT_L_G14 :{0x7066,0x00E1,0x02},    // G0_KNOT_L_G15 :{0x7068,0x00E1,0x02},    // G0_KNOT_L_G16 :{0x706A,0x00E1,0x02},    // G0_KNOT_L_G17 :{0x706C,0x00E1,0x02},    // G0_KNOT_L_G18 :
...
{0x980E,0x32,0x01},    // CS_CBHLEV_A :
{0x9811,0x28,0x01},    // CS_CRHLEV_A :
{0x981A,0x0A,0x01},    // CS_SLP_YC_L_A :
{0x981D,0x14,0x01},    // CS_SLP_Y_L_A :
{0x9820,0x3C,0x01},    // CS_YLCOEF_A :
{0x9823,0x3C,0x01},    // CS_CBHLEV_Y_L_A :
{0x982A,0xFFD8,0x02},    // CS_CBLLEV_A :
{0x9830,0xFFCE,0x02},    // CS_CRLLEV_A :
{0x9842,0xFFD8,0x02},    // CS_CBLLEV_Y_L_A :
{0x921D,0x39,0x01},    // GAIN_TH_A_TYPE7 :
{0x921E,0x36,0x01},    // GAIN_TH_B_TYPE7 :
{0x921F,0x19,0x01},    // GAIN_TH_C_TYPE7 :
...
/* Enhanced softlanding, but delay 100 increased */
static const isx012_regset_t ISX012_Sensor_Off_VCM2[] =
{
{0x6674,0x01,0x01},    // AF_MONICHG_MOVE_F
{0x00B2,0x02,0x01},    //AFMODE_MONI : Manual AF mode
{0x0081,0x00,0x01},    //MODESEL : Monitoring mode
{0x0082,0x01,0x01},    //MONI_REFRESH
{0xFFFF,0xC8,0x01},    // $wait, 200
{0x6600,0x0000,0x02},    // AF_SEARCH_AREA_LOW
{0x6666,0x0000,0x02},    // AF_AREA_LOW_TYPE1
{0x6648,0x00C8,0x02},    // AF_MANUAL_POS :
{0x00B1,0x01,0x01},    //AF_RESTART_F
...
{0x6828,0x0007,0x02},    // SHD_PRER_OFFSET_R2 : 

//PreWB offset SHD3(A)
{0x682C,0x0008,0x02},    // SHD_PRER_OFFSET_RB : 
{0x6830,0x0003,0x02},    // SHD_PREB_OFFSET_RB : 

// CXC/SHD EN
{0x01BC,0x57,0x01},    // CXC ON SHD ON INP ON GAIN ON
};
...
//PreWB offset SHD2(TL84)
{0x6828,0x0010,0x02},    // SHD_PRER_OFFSET_R2 : 
...
{0x9830,0xFFEC,0x02},    // CS_CRLLEV_A :
{0x9842,0xFFCE,0x02},    // CS_CBLLEV_Y_L_A :
{0x921D,0x31,0x01},    // GAIN_TH_A_TYPE7 :
{0x921E,0x21,0x01},    // GAIN_TH_B_TYPE7 :
{0x921F,0x19,0x01},    // GAIN_TH_C_TYPE7 :
};
